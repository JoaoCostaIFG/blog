...
export default function About() {
	return (
		<TerminalWindow
			...
			title="root@joaocosta:~# cat about.md"
		>
			<div className="grid grid-cols-12 gap-6">
				<div className="prose prose-invert m-auto col-span-12 font-sans sm:col-span-8">
					...
					<p>
						...
						partner (who is probably my only reader) ends up pointing out most
						of the errors, so I can fix them. Still, feel free to shoot me an
						email if you thing something not quite right.
					</p>
					<p>
					...
					<p>
						...
						ones (<em>I use Arch BTW</em>) or the servers, or automating stuff.
						I&apos;m always looking for something that I can fix and/or
						optimize.
					</p>
					<p>
					...
					<p>
						...
						away from it as possible. Still, I have a LinkedIn account for work
						reasons.
					</p>
					<p>
				...
				<figure className="col-span-12 flex max-w-xs flex-col mx-auto sm:order-first sm:col-span-4 sm:max-w-full sm:sticky sm:top-20 sm:self-start">
					<Image
						...
						priority={true}
					/>
					<figcaption className="not-prose mt-2 text-center font-mono text-xs text-term-mute">
						(This is the profile picture I usually use online. It was generated
						using my{" "}
						<a className="anchor" href="https://gitlab.com/JoaoCostaIFG/allrgb">
							AllRGB program
						</a>
						.)
					</figcaption>
